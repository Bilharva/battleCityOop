...
/**
 * Utilitário estático para processamento de imagens.
 *
 * BMPs não suportam transparência nativamente — eles têm um fundo colorido
 * sólido em volta dos sprites. Este utilitário remove essa cor de fundo
